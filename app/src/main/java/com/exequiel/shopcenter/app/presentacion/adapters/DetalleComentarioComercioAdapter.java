 ...
 */
public class DetalleComentarioComercioAdapter extends RecyclerView.Adapter<DetalleComercioHoler> {

    private List<Object> listData;

    @Override
    public DetalleComercioHoler onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_detalle_com_comentario,parent,false);
