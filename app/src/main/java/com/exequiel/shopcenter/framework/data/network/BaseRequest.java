...
public abstract class BaseRequest {
    ...
    /**
     * Pasar por par�metro los campos obligatorios en las clases especializadas
     * de lo contrario el m�todo fallar�, es un request no visible en segundo plano
     * @param tipo
    ...
    protected BaseRequest(TipoRequest tipo, Context context, String posFijoUrlDefecto,
        ...
        }//TODO si no hay post fijo deber�a saltar una excepcion
    }
    ...
    private Request crearRequest(TipoRequest tipo, int method, Object obReq, HashMap headers){
        ...
        switch (tipo){
            case JSON_OBJECT_REQUEST:
                ...
                break;
            case IMAGE_REQUEST:
                //TODO tERMINAR ESTA IMPLEMENTACI�N VERIFICAR COMO FUNCIONA SEG�N LA DOCUMENTACI�N
